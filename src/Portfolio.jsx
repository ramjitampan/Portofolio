    ...
    <div className="App">
      ...
      <div className="w3-padding-large" id="main" style={{ backgroundColor: '#000', color: '#fff' }}>
        <header className="w3-container w3-padding-32 w3-center w3-black" id="home" data-aos="fade-up">
          ...
          <img src="public/Ramzyganteng.png" alt="boy" className="w3-image" style={{ width: '100%', height: 'auto' }} />
        </header>
        ...
        <div className="gallery-container" data-aos="fade-up">
          <div className="gallery">
            <img src="public/SKILL ISU.png" alt="Design 1" className="gallery-item" data-aos="zoom-in" />
            <img src="public/revamp fami x ramzy.png" alt="Design 2" className="gallery-item" data-aos="zoom-in" />
            <img src="public/Brian Makmur.PNG" alt="Design 3" className="gallery-item" data-aos="zoom-in" />
            <img src="public/SUNSET.png" alt="Design 4" className="gallery-item" data-aos="zoom-in" />
            <img src="/SUNSET_UNP.png" alt="Design Square 1" className="gallery-item" data-aos="zoom-in" />
            <img src="public/fahmix andri.png" alt="Design Square 2" className="gallery-item" data-aos="zoom-in" />
          </div>
        </div>
